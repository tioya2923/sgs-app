          ...
          <Button
            ...
            onClick={() => {
              ...
              if (ehNovoArtigo) {
                ...
                if (!nomeNovo) return;
                // Um nome escrito de novo (espaço a mais, maiúscula diferente...)
                // que já existe neste armazém não deve virar um segundo artigo —
                // isso partia o stock em dois registos e desacertava os alertas
                // de mínimo/esgotado.
